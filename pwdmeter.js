...
function chkPass(idPwd) {

    var obj = $("#" + idPwd);
    var pwd = obj.val();

    // Geek Part
    strengthMeter(idPwd, $("#nodes").val());
	
    // Analyse
    var oScorebar = $u("scorebar");
    var oScore = $u("score");
    var oComplexity = $u("complexity");
    ...
    if (pwd) {
		...
		// Hash part
		$u("sha256").innerHTML = Sha256.hash(pwd);
		$u("sha1").innerHTML = Sha1.hash(pwd);
		
		md5(pwd);
		/*var hash = md5.create();
		hash.hex();*/
		$u("md5").innerHTML = md5(pwd);;
        ...
        $u("nLengthBonus").innerHTML = "+ " + nScore;
        ...
        $u("nAlphaUCBonus").innerHTML = sAlphaUC;
        $u("nAlphaLCBonus").innerHTML = sAlphaLC;
        $u("nNumberBonus").innerHTML = sNumber;
        $u("nSymbolBonus").innerHTML = sSymbol;
        $u("nMidCharBonus").innerHTML = sMidChar;
        ...
        $u("nAlphasOnlyBonus").innerHTML = sAlphasOnly;
        $u("nNumbersOnlyBonus").innerHTML = sNumbersOnly;
        $u("nRepCharBonus").innerHTML = sRepChar;
        $u("nConsecAlphaUCBonus").innerHTML = sConsecAlphaUC;
        $u("nConsecAlphaLCBonus").innerHTML = sConsecAlphaLC;
        $u("nConsecNumberBonus").innerHTML = sConsecNumber;
        $u("nSeqAlphaBonus").innerHTML = sSeqAlpha;
        $u("nSeqNumberBonus").innerHTML = sSeqNumber;
        $u("nSeqSymbolBonus").innerHTML = sSeqSymbol;
        ...
        for (var c = 0; c < arrCharsLen; c++) {
            var oImg = $u('div_' + arrCharsIds[c]);
            var oBonus = $u(arrCharsIds[c] + 'Bonus');
            $u(arrCharsIds[c]).innerHTML = arrChars[c];
        ...
        $u("nRequirementsBonus").innerHTML = sRequirements;
...
function togPwdMask() {
    var oPwd = $u("passwordPwd");
    var oTxt = $u("passwordTxt");
    var oMask = $u("mask");
    if (oMask.checked) {
...
function initPwdChk(restart) {
    ...
    for (var i in arrZeros) {
        $u(arrZeros[i]).innerHTML = "0";
    }
    for (var i in arrPassPars) {
        $u(arrPassPars[i]).parentNode.className = "pass";
    }
    for (var i in arrPassDivs) {
        $u(arrPassDivs[i]).className = "pass";
    }
    for (var i in arrFailPars) {
        $u(arrFailPars[i]).parentNode.className = "fail";
    }
    for (var i in arrFailDivs) {
        $u(arrFailDivs[i]).className = "fail";
    }
    $u("passwordPwd").value = "";
    $u("passwordTxt").value = "";
    $u("scorebar").style.backgroundPosition = "0";
    if (restart) {
        $u("passwordPwd").className = "";
        $u("passwordTxt").className = "hide";
        $u("mask").checked = true;
    }
}
